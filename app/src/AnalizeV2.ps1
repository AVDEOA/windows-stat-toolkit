...
$outputPath = Join-Path -Path $outputRoot -ChildPath 'AnalizeV2.txt'
$now = Get-Date
...
$analysis.purpose = 'Структурированный JSON для чтения и анализа нейросетью по состоянию ПК, ошибкам и вероятным причинам.'
...
Write-Host ''
Write-Host ('Файл анализа V2 создан: {0}' -f $outputPath)
