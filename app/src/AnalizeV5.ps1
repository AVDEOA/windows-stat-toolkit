...
$outputPath = Join-Path -Path $outputRoot -ChildPath 'AnalizeV5.txt'
$now = Get-Date
...
$analysis.purpose = 'Forensic + inventory + configuration audit JSON v5 для чтения и анализа нейросетью по состоянию юнита, ошибкам, конфигурации и вероятным причинам.'
...
Write-Host ''
Write-Host ('Файл анализа V5 создан: {0}' -f $outputPath)
