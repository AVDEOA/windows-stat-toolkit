...
Structured Windows diagnostics toolkit with a compiled desktop `exe`, local evidence collection, AI-friendly analysis prep, native-first remote SSH collection with PowerShell fallback, and concept monitoring with Telegram alerts.
