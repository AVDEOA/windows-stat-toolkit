...
- GitHub publication trail for this release uses branch `windows-stat-toolkit-analysis`, tag `windows-stat-toolkit-analysis-v0.6.0`, and the runnable asset `WindowsStatToolkit-v0.6.0-win-x64.zip`.
