...
- Current active package is `v0.6.1`: stabilize remote collection by moving the desktop SSH execution layer to an embedded client with password auth, fingerprint registration, and explicit SSH testing.
